...
This file provides guidance to coding agents when working in `apps/frontend`. The
...
is in the root `AGENTS.md` — the generated Prisma client having exactly one runtime consumer is what
